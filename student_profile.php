...
$sql="SELECT* FROM register WHERE uname='$name' && role='student'";
    ...
    <ul>
       ...
       <div style="width:100%;" class="content" >
        ...
        <form style="width:100%;" >
         ...
         <div>
		  <label></label>
                <a href="student_profile1.php" style="padding:10px 20px;background:#0000FF;color:#FFFFFF;border-radius:8px;font-size:18px;">Update</a>
            </div>
