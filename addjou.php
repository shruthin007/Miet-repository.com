...
if(isset($_POST['btn']))
{
$max_qry = mysqli_query($conn,"select max(id) from journal");
	$max_row = mysqli_fetch_array($max_qry); 
	$id=$max_row['max(id)']+1;
  


$qry=mysqli_query($conn,"insert into journal value ('','$journal','$pub','$title','$auth','$link')");
if($qry)
{
?>
<script language="javascript">
	alert("Journal Added Successfully..");
	window.location.href="addjou.php";
	</script>
		<?php
}
else
       ...
       <div style="width:100%;" class="content" >
        ...
        <p>&nbsp;</p>
            ...
            <td width="72%" valign="top"><div align="justify" class="style3">
                ...
                <h3 align="left"><span class="style4"><strong>Add Journal Details: </strong></span></h3>
              ...
              <div align="left">
                <table width="70%" border="0" align="center">
                  ...
                  <tr>
                    ...
                    <td width="25%"><strong>Journal </strong></td>
                    <td width="61%"><input name="journal" type="text"  /></td>
                    <td width="5%">&nbsp;</td>
                    <td width="2%">&nbsp;</td>
                  </tr>
                  <tr>
				   ...
				   <tr>
                    ...
                    <td><input name="auth" type="text" id="auth" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
